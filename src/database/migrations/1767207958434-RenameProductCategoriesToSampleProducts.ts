...
export class RenameProductCategoriesToSampleProducts1767207958434 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (productCategoriesExists) {
            await queryRunner.query(`INSERT INTO "sample_products" ("id", "name", "description", "code", "isActive", "createdAt", "updatedAt") SELECT "id", "name", "description", "code", "isActive", "createdAt", "updatedAt" FROM "product_categories"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."files_modulename_enum" AS ENUM('user', 'role', 'permission', 'file', 'sample-product', 'general')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."files_modulename_enum_old" AS ENUM('user', 'role', 'permission', 'file', 'general')`);
        await queryRunner.query(`ALTER TABLE "files" ALTER COLUMN "moduleName" DROP DEFAULT`);
